    ...
    const model = [
        ...
        },
        {
            ...
            items: [
                ...
                { label: 'Настройки', icon: 'pi pi-fw pi-id-card', to: '/crm/admin/config/' },
                ...
                { label: 'Создать спецификацию', icon: 'pi pi-fw pi-id-card', to: '/crm/offersCreate' },
                { label: 'КП', icon: 'pi pi-fw pi-id-card', to: '/crm/offers' },
                { label: 'Калькулятор', icon: 'pi pi-fw pi-id-card', to: '/crm/calculator' },
